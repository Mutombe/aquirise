...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-slate-900 text-white py-12 sm:py-16"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-3">
            <h4 className="gravesend-sans text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-white">
              Quick Links
            </h4>
        ...
        <div className="mb-8 sm:mb-12">
          <div className="text-center rounded-sm p-6 sm:p-8 backdrop-blur-sm border border-slate-700">
            <h4 className="gravesend-sans text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-white">
