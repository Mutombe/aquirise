      ...
      >
        <defs>
          <linearGradient
            ...
            y2="100%"
          >
            <stop offset="0%" stopColor="#001D39" stopOpacity="0.8" />
            <stop offset="25%" stopColor="#0A4174" stopOpacity="0.6" />
            <stop offset="50%" stopColor="#49769F" stopOpacity="0.4" />
            <stop offset="75%" stopColor="#4E8EA2" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#6EA2B3" stopOpacity="0.2" />
          </linearGradient>

          <radialGradient id="hero-shadow-radial" cx="50%" cy="50%" r="60%">
            <stop offset="0%" stopColor="#000000" stopOpacity="0.2" />
            <stop offset="50%" stopColor="#0A4174" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#001D39" stopOpacity="0.6" />
          </radialGradient>
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className="max-w-4xl space-y-3 sm:space-y-4 lg:space-y-6">
              <h1 className="gellix-font font-light text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl leading-tight text-white transform transition-all duration-500 opacity-100">
